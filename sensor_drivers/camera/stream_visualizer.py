#!/usr/bin/env python3
    ...
    # Date: 07/09/2024
    # Description: Este nodo se encarga de ejecutar una instancia de visualizacion del stream de la cámara

    # Example Usage:
    # rosrun sensor_drivers stream_visualizer.launch
import sys
...
def main():
    ...
    # todo Poner parámetro para recibir la ip deseada 
    ip_address = "127.0.0.1:30000" # local
    # ip_address = "192.168.1.105:30000" #Jetson
